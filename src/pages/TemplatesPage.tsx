...
function inferPeopleMode(t: Template): PeopleMode {
  ...
  if (
    /双人|两人|情侣|夫妻|新郎新娘|合照|couple|wedding couple|bride and groom/.test(text)
  ) return 'couple'
  if (
    /单人|个人|肖像|solo|single portrait|新娘单人|新郎单人/.test(text)
  ) return 'single'
  return 'unknown'
}
...
export default function TemplatesPage() {
  ...
  const pick = (t: Template) => {
    ...
    if (currentMode && nextMode !== 'unknown' && currentMode !== nextMode) {
